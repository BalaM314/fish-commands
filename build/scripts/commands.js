...
function resolveArgsRecursive(processedArgs, unresolvedArgs, sender, callback) {
    if (unresolvedArgs.length == 0) {
        ...
        */
        (0, menus_1.listMenu)("Select a player", "Select a player for the argument ".concat(argToResolve_1.name), new menus_1.GUI_Container(optionsList_1, "auto", function (player) { return player.name; }), sender, function (_a) {
            var data = _a.data;
